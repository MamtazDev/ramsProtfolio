...
const SkillsInfo = () => {
  ...
  return <div className="row skillInfoContainer">
    <div className="col-6">
      <div className="mySubjectContainer">
        <h2>My subject
          matter expertise</h2>
        <p>I have an extensive working knowledge of application and web development. </p>
        <button className="btn">Get in Touch</button>
      </div>
    </div>
    <div className="col-6">
      <div className="row skillInfoCards">
        {skills.map((item, idx) => <SkillInfoCard key={idx} skill={item} />)}
      </div>
    </div>
  </div>;
};
